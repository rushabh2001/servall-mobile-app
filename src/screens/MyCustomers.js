...
import { View, Text, StyleSheet, Linking, ActivityIndicator, FlatList, RefreshControl, TouchableOpacity } from "react-native";
...
const MyCustomer = ({ navigation, userToken, selectedGarageId, selectedGarage, user }) => {
                        ...
                        (filteredData?.length > 0 ?  
                            <>
                                <FlatList
                                    ...
                                    data={filteredData}
                                    onEndReached={filteredData?.length > 9 && getCustomerList}
                                    ...
                                    renderItem={({item, index}) => (
                                        <>
                                            <List.Item
                                                ...
                                                right={() => <Icon onPress={() => { this[RBSheet + index].open(); }}  type={"MaterialCommunityIcons"} style={{right: 5, top: 8,position: 'absolute',}} name={'dots-vertical'} size={22}  color={colors.gray} />}
                                            />
                                            <RBSheet
                                                ref={ref => {
                                                ...
                                                <View style={{flexDirection:"column", flex:1}}>
                                                    <List.Item
                                                        ...
                                                        onPress={() => { navigation.navigate("CustomerDetails", { userId: item.id });  this[RBSheet + index].close();  }}
