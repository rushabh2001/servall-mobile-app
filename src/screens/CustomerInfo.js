...
import { Button,  Modal, Portal, Divider, TextInput, List, Searchbar } from 'react-native-paper';
import InputScrollView from 'react-native-input-scroll-view';
import { Picker } from '@react-native-picker/picker';
import IconX from "react-native-vector-icons/FontAwesome5";

const CustomerInfo = ({ navigation, userToken, route, selectedGarageId, selectedGarage, user }) => {
